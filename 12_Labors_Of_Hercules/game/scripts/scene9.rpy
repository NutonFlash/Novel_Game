image bg forest_evening = 'images/scene9/forest_evening.png'

label scene9:

    scene bg forest_evening with fade
    
    'Hercules, having earned the trust of the centaurs, sits among them in the peaceful clearing.'
    
    'As the warm glow of the sunset casts its final rays, the centaurs share a tale of heartache and desperation.'

    show hercules at right
    show centaur_father at left
    with dissolve
    ...
    show centaur_mother at left with dissolve

    centaur_mother 'The leader of these bandits is Isidore. He despises centaurs and delights in tormenting our little one.'
    
    centaur_mother 'He keeps her imprisoned in a cruel cage, subjecting her to endless mockery. The bastards have established their camp in the treacherous Wailing Woods, to the east of the Great River.'
    ...
    show centaur_father at left with dissolve
